...
const Buttons = ({ id }: { id: number }) => {
  ...
  return (
    ...
    <div className="flex justify-between mb-5">
     ...
     <button disabled={isPending} onClick={() => mutate()} className="flex items-center gap-2 border py-1 px-3 rounded-md 
     transition hover:bg-red-200 hover:shadow disabled:bg-zinc-300">
      <FaRegTrashAlt/>  
      Sil
      </button>
    </div>
